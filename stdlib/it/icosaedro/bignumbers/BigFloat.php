 ...
 *  @version $Date: 2013/05/30 16:01:02 $
 *  @license http://www.icosaedro.it/license/bsd-style.html BSD-style
 */
class BigFloat implements Printable, Comparable, Sortable, Hashable
{
	 ...
	 *
	 *  <b>int</b> numbers and {@link BigInt} numbers can always be
	 ...
	 *         int, float, string or {@link BigInt}.
	 *  @return void
