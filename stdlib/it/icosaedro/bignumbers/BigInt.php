...
class BigInt implements Printable, Comparable, Sortable, Hashable
{
	...
	/**  The sign: +1 for numbers >= 0, -1 otherwise. */
	private /*. int    .*/ $sgn = 0;
	 ...
	 *          of 1 is zero, the scale factor of 10 is 2.
	 */
	function scale()
	{
