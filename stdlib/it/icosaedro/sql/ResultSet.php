...
/**
	...
	For semplicity, most of the methods return {@link SQLException} for both
...
abstract class ResultSet implements Printable {
	...
	*/
	abstract function moveToRow(/*. int .*/ $row_index);
	...
	*/
	...
	/**
		...
		@return bool If the internal pointer was succesfully moved to the
	...
	*/
	...
	/**
		...
		@throws SQLException
	*/
	abstract function getStringByIndex(/*. int .*/ $column_index);
