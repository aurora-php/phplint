...
/**
	...
	elements implements the {@link Hashable} interface, so that the getHash()
	...
	functions provided by the {@link Hash} class are applied to calculate the
	hash, while the function {@link Equality::areEqual()} provides a quite
	...
	@version $Date: 2012/02/01 08:11:13 $
*/
class HashSet implements \Countable, \Iterator, Printable, Comparable {
	...
	*/
	...
	/**
		...
		@return bool True if $other is not NULL, belogns to this same class
		(not extended) and the two set contains the same elements according to
		the {@link Equality::areEqual()} method.
	*/
