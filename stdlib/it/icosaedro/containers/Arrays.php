...
/**
	Utility functions to manipulate arrays. Arrays must have int indeces
	T[int], with T that may be int, float, string or object of any class.
	If T is an object that implements {@link Sortable}, a specific sorting
	function is provided, otherwise a custom {@link Sorter} object may be
	...
	{@link Sortable} interface, while the sortBySorter() allows to
...
class Arrays {
	...
	/**
		...
		empty, but not NULL.
		@return Sortable[int] Sorted array. The indeces, all of type
	...
	*/
	...
	/**
		...
		@return object[int] Sorted array. The indeces, all of type
		int, start from 0. The passed array is not modified.
	...
	*/
	...
	/**
		...
		@return int[int] Sorted array. The indeces, all of type
		int, start from 0. The passed array is not modified.
	*/
	...
	/**
		...
		Applies the total ordering imposed by {@link Floats::compare()}.
		@param float[int] $a Array to be sorted.
		@return float[int] Sorted array. The indeces, all of type
		int, start from 0. The passed array is not modified.
	*/
	...
	/**
		...
		@return string[int] Sorted array. The indeces, all of type
		int, start from 0. The passed array is not modified.
	*/
