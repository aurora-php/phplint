...
/**
	...
	juggling. Moreover, supports objects that implements the {@link Comparable}
	class.
...
class Equality {
	...
	/**
		...
		interfaces cannot define static methods, so it gone there.
		...
		Floating point values are compared using {@link Floats::compare()}.
		...
		implement {@link Comparable::equals()}, the value of this latter method
		is returned instead.
	*/
