...
*/
class Bytes implements Printable, Sortable, Hashable, \Serializable {

	/* The array of bytes, immutable. */
	private /*. string .*/ $s;
	/* Lower case of $s, calculated once for all if required. */
	private /*. string .*/ $s_lc;
	...
	*/
	 ...
	 * @return int  Less that 0 if $a<$b, greather than zero if $a>$b,
