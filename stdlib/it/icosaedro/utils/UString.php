...
/**
	...
	@version $Date: 2012/05/06 16:08:24 $
*/
final class UString implements Printable, Sortable, Hashable, Serializable
{
	...
	*/
	...
	/**
		...
		NULL is returned.
	*/
	private static function factory($s)
	{
		if( $s === NULL )
			return NULL;
	...
	*/
	...
	function charAt($i)
	{
		...
		return self::factory( Strings::substring($this->s, $byte_index, $byte_index + $seq_len) );
	}
	...
	*/
	...
	/**
		...
		@throws OutOfRangeException Invalid range: must be 0 <= $a <= $b <=
	...
	*/
	 ...
	 * given position.
	 * @throws OutOfRangeException Invalid range: must be 0 <= $at <=
	 * $this->length().
	 */
	...
	*/
	...
	{
		if( $blacklist === NULL )
			return self::factory( trim($this->s) );
	...
	/**
		Compare strings. Implements the {@link Sortable} interface.
