...
/*. private .*/ class EmptyGroup implements Group {
 ...
 */
/*. private .*/ class BeginningMatcher extends MatcherOperator {
 ...
 */
/*. private .*/ class EndingMatcher extends MatcherOperator {
...
/**
 * Matches a single byte. Used when the Pattern's constructor operates in
 * non-UTF-8 mode.
 */
/*. private .*/ class AnyMatcher extends MatcherOperator {
 ...
 * result of the parsing through the {@link Element} and the {@link Group}
 ...
 * </code></center>
 *
 * The Pattern class provides the {@link Element} interface that allows
 * to access the outermost element number 0: the {@link Element::start()}
 * method returns the offset of the beginning of the subject string that
 * matches the whole pattern; the {@link Element::end()} method returns
 * the ending of the portion that matched the pattern; finally, the {@link
 * Element::value()} method returns this portion of the subject string:
 *
 * <pre>
 ...
 * </pre>
 *
 * The Element interface also provides the {@link Element::group($g)}
 * that retrieves the specified group as instance of the {@link Group}
 ...
 * element, and {@link Group::elem($i)} retrieves the element number $i with
 * 0 <= $i < count().
 *
 ...
 * @version $Date: 2012/05/06 16:07:01 $
 */
